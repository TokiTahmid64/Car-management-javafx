...
public class userMainPageController {
    ...
    //Function for retrieving and showing Car list on Table
    public void viewAllCars(ActionEvent e) {
    ...
    //Function for buying a car

    public void buyCar(ActionEvent e) throws IOException {
        stg.close();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("buyCarId.fxml"));
        Parent root = loader.load();
        Scene mainScene = new Scene(root);
        Stage window = new Stage();
        window.setScene(mainScene);
        buyCarIdController controller = loader.getController();
        controller.getSocket(s);
        controller.getStage(window);
        window.show();
    }

    //Function for searching car based on Registration number
    public void idSearch(ActionEvent e) throws IOException {

        stg.close();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("viewRegUser.fxml"));
        Parent root = loader.load();
        Scene mainScene = new Scene(root);
        Stage window = new Stage();
        window.setScene(mainScene);
        viewRegUserController controller = loader.getController();
        controller.getSocket(s);
        controller.getStage(window);
    ...
    //Function for searching car based on Model and CarMake
    public void modelSearch(ActionEvent e) throws IOException {
        stg.close();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("viewModelUser.fxml"));
        Parent root = loader.load();
        Scene mainScene = new Scene(root);
        Stage window = new Stage();
        window.setScene(mainScene);
        viewModelUserController controller = loader.getController();
        controller.getSocket(s);
